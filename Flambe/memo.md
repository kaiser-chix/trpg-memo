    ...
    - 入ろう
      ...
      - 資料が見つかった
        ...
        - R 実験対象者
          ...
          > |マーカス・ブラウン|人間|魔動機術|基準値満たず処分別の優秀な個体達を試す|
          > |――――――――――|――――――――――|――――――――――|――――――――――|
          ...
          > |――――――――――|――――――――――|――――――――――|――――――――――|
          > |ルシウス・ヴァレンタイン|人間|神聖魔法|旧候補者詳しくは※3を確認|
          > |アナスタシア・ド・ルセリス|エルフ|魔動機術|旧候補者詳しくは※3を確認|
          > |エレン・クローヴァ|人間|妖精魔法|旧候補者詳しくは※3を確認|
          > |――――――――――|――――――――――|――――――――――|――――――――――|
          ...
          > 明日、確保することにする。<br>
          > <br>
          > ※3"異界送り"以降に見つけた適正者確保前にシオンの存在を確認、以降観測を停止<br>
